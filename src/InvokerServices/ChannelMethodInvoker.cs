    ...
    internal class ChannelMethodInvoker : IChannelMethodInvoker
    {
        ...
        public void InvokeChannelMethod(Type channel, MethodInfo method, HttpListenerResponse response)
        {
            ...
            else
            {
                ...
                if (chResponse.GetType().GetCustomAttribute<StandardJsonMessageAttribute>() != null || method.GetCustomAttribute<StandardJsonMessageAttribute>() != null)
                {
                    WriteResponse(chResponse, response, true);
                }
                else
                    WriteResponse(chResponse, response, false);
            }
        }
        ...
        public void InvokeChannelMethodSync(Type channel, MethodInfo method, HttpListenerResponse response, List<object> channelRequestBody)
        {
            ...
            if (chResponse != null && chResponse.GetType().GetCustomAttribute<StandardJsonMessageAttribute>() != null || method.GetCustomAttribute<StandardJsonMessageAttribute>() != null)
            {
                WriteResponse(chResponse, response, true);
            }
            else
        ...
        public void InvokeChannelMethodAsync(Type channel, MethodInfo method, HttpListenerResponse response, List<object> channelRequestBody)
        {
            ...
            if (chResponse.GetType().GetCustomAttribute<StandardJsonMessageAttribute>() != null || method.GetCustomAttribute<StandardJsonMessageAttribute>() != null)
            {
                WriteResponse(resultValue, response, true);
            }
            else
                WriteResponse(resultValue, response, false);
        }
